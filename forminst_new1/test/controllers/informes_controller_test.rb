...
class InformesControllerTest < ActionController::TestCase
  ...
  test "should create informe" do
    assert_difference('Informe.count') do
      post :create, informe: { PlanFormacionId: @informe.PlanFormacionId, conclusiones: @informe.conclusiones, id: @informe.id, opinionTutor: @informe.opinionTutor, tutorId: @informe.tutorId }
    end
  ...
  test "should update informe" do
    patch :update, id: @informe, informe: { PlanFormacionId: @informe.PlanFormacionId, conclusiones: @informe.conclusiones, id: @informe.id, opinionTutor: @informe.opinionTutor, tutorId: @informe.tutorId }
    assert_redirected_to informe_path(assigns(:informe))
  end
