...
class DocumentosControllerTest < ActionController::TestCase
  ...
  test "should create documento" do
    assert_difference('Documento.count') do
      post :create, documento: { archivo: @documento.archivo, id: @documento.id, informeActividadId: @documento.informeActividadId }
    end
  ...
  test "should update documento" do
    patch :update, id: @documento, documento: { archivo: @documento.archivo, id: @documento.id, informeActividadId: @documento.informeActividadId }
    assert_redirected_to documento_path(assigns(:documento))
  end
