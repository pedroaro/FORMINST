...
class ActividadsControllerTest < ActionController::TestCase
  ...
  test "should create actividad" do
    assert_difference('Actividad.count') do
      post :create, actividad: { actividad: @actividad.actividad, anulada: @actividad.anulada, id: @actividad.id, tipoActividadId: @actividad.tipoActividadId }
    end
  ...
  test "should update actividad" do
    patch :update, id: @actividad, actividad: { actividad: @actividad.actividad, anulada: @actividad.anulada, id: @actividad.id, tipoActividadId: @actividad.tipoActividadId }
    assert_redirected_to actividad_path(assigns(:actividad))
  end
