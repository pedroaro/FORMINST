...
class RevisionsControllerTest < ActionController::TestCase
  ...
  test "should create revision" do
    assert_difference('Revision.count') do
      post :create, revision: { adecuacionId: @revision.adecuacionId, estatusId: @revision.estatusId, fecha: @revision.fecha, id: @revision.id, informeId: @revision.informeId, usuarioId: @revision.usuarioId }
    end
  ...
  test "should update revision" do
    patch :update, id: @revision, revision: { adecuacionId: @revision.adecuacionId, estatusId: @revision.estatusId, fecha: @revision.fecha, id: @revision.id, informeId: @revision.informeId, usuarioId: @revision.usuarioId }
    assert_redirected_to revision_path(assigns(:revision))
  end
